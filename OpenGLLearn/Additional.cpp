...
void CheckShaderStatus2(GLuint shader);
void CheckProgramStatus2(GLuint shaderProg);
...
int main2()
{
    ...
    CheckShaderStatus2(vertexShader);
    ...
    CheckShaderStatus2(fragmentShader);
    ...
    CheckProgramStatus2(shaderProgram);
